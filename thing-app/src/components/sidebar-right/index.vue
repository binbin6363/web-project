...
import ConversationList from '@/components/conversation-list/index.vue'
import FriendList from '@/components/friend-list/index.vue'
import ApplyList from '@/components/apply-list/index.vue'
import DialogAddFriend from '@/components/dialog-add-friend/index.vue'
